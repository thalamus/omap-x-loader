...
struct dpll_param mpu_dpll_param[7] = {
	...
	/* RUN MPU @ 600 MHz */
	{0xfa, 0x07, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00},
#else
	{0x34, 0x02, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00},
#endif
};
...
static void enable_all_clocks(void)
{
	...
	*(volatile int*)0x55080a20 = 0x00000007;
	...
	sr32(CM1_ABE_MCBSP1_CLKCTRL, 0, 32, 0x080000002);
	sr32(CM1_ABE_MCBSP2_CLKCTRL, 0, 32, 0x080000002);
	sr32(CM1_ABE_MCBSP3_CLKCTRL, 0, 32, 0x080000002);
	...
	sr32(CM_L4PER_ADC_CLKCTRL, 0, 32, 0x2);
	...
	sr32(CM_L4PER_ELM_CLKCTRL, 0, 32, 0x2);
	...
	sr32(CM_L4PER_HECC1_CLKCTRL, 0, 32, 0x2);
	sr32(CM_L4PER_HECC2_CLKCTRL, 0, 32, 0x2);
	...
	sr32(CM_L4PER_L4PER_CLKCTRL, 0, 32, 0x2);
	sr32(CM_L4PER_MCASP2_CLKCTRL, 0, 32, 0x2);
